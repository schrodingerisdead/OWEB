...
create_app("My Sanity", "../assets/images/apps/recycle-bin.png", "recycle-bin")
...
create_app("Wordle","../assets/images/apps/wordle.png","wordle",href="../assets/wordle")

//Functions
function create_Wordle(name, image, id){
    let app = document.createElement("div")
    app.classList.add("app").add(href="../assets/wordle/wordle.html");
    app.id = id
